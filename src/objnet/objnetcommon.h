...
//    svcSubobjectInfo    = 0x81, //!< описание поля объекта
    ...
    svcUpgradeStart     = 0xB0, //!< запуск обновления прошивки, в данных класс устройства
    svcUpgradeConfirm   = 0xB1, //!< подтверждение начала прошивки, чтобы не было случайностей
    svcUpgradeEnd       = 0xB2, //!< окончание обновления прошивки
    svcUpgradeSetPage   = 0xB3, //!< установка текущей страницы
    svcUpgradeData      = 0xB4, //!< собственно, сама прошивка (см. протокол)
    svcUpgradeAddress   = 0xB5, //!< адрес начала прошивки
    svcUpgradeProbe     = 0xB6, //!< мастер после отправки страницы спрашивает, всё ли ок
    svcUpgradeRepeat    = 0xB8, //!< запрос повтора страницы
    svcUpgradePageDone  = 0xB9, //!< прошиваемые устройства говорят, что всё хорошо
    svcUpgradeAccepted  = 0xBA, //!< прошиваемые устройства обозначают себя
    svcUpgradeReady     = 0xBB, //!< прошиваемые устройства готовы принимать прошивку
    ...
    svcAutoGroupRequest = 0xFD, //!< мастер говорит узлу, что хочет получать группированный объект без лишних слов
